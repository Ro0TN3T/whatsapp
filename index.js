        ...
        if(type === "notify"){
            if(!messages[0].key.fromMe) {
                ...
                if(!messages[0].key.fromMe && pesanMasuk === "ping"){
                    ...
                    await sock.sendMessage(noWa, {text: "Whatsapp Ini Khusus Untuk Kirim *OTP* Silahkan Hubungi Cs Kami Untuk Bantuan!"},{quoted: messages[0] });
                }
			}		
		}		
    });
...
app.post("/send-message", async (req, res) =>{
    ...
    try {
        if(!req.files) 
        {
            ...
            {
                phoneWA = '62' + phone.substring(1) + "@s.whatsapp.net"; 
                console.log(await sock.onWhatsApp(phoneWA));
                if (isConnected) {
                    const exists = await sock.onWhatsApp(phoneWA);
        ...
        else
        {
            ...
            else
            {
                ...
                phoneWA = '62' + phone.substring(1) + "@s.whatsapp.net"; 
                //console.log('Kirim document ke'+ phoneWA);
